    ...
    return (
      ...
      {/* headings */}
        ...
        <Form.Group className= "cols" as={Col} md="4" controlId="formGridAddress1">
            ...
            <Form.Control className = "input-boxes" placeholder="Enter address" />
        </Form.Group>

        <Form.Group className= "cols" as={Col} md="4" controlId="exampleForm.ControlSelect1">
            <Form.Label>City</Form.Label>
            <Form.Control  className = "input-boxes" as="select">
        ...
        <Button variant="dark" className="next-button-styling" type="submit">NEXT</Button>
      </Form>
    );
  }
